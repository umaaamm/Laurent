...
$route['KelolaUser'] ='ControllerUser';
$route['SimpanUserDaftar'] ='ControllerUser/simpan_u';
$route['KelolaKronologi'] ='ControllerKronologi';
$route['KelolaKronologiUser'] ='ControllerKronologi/untuk_user';
$route['SimpanUser'] ='ControllerUser/simpan';
$route['SimpanAdmin'] ='ControllerAdmin/simpan';
$route['SimpanKronologi'] ='ControllerKronologi/simpan';
$route['SimpanKronologiUser'] ='ControllerKronologi/simpan_user';
$route['HapusAdmin'] ='ControllerAdmin/hapus';
$route['HapusUser'] ='ControllerUser/hapus';
$route['HapusKronologi'] ='ControllerKronologi/hapus';
$route['DataKronologi'] ='ControllerKronologi/datakronologi';
$route['Admin'] = 'ControllerLogin';
$route['User'] = 'ControllerLoginUser';
$route['CekLogin'] = 'ControllerLogin/aksi_login';
$route['CekLoginUser'] = 'ControllerLoginUser/aksi_login_user';
$route['DataKronologiUser'] ='ControllerKronologi/datakronologiuser';
$route['LaporanFilter'] ='ControllerLaporan/filter';
$route['LaporanFilterUser'] ='ControllerLaporan/filter_user';
$route['KelolaPelayanan'] ='ControllerPelayanan';
$route['SimpanPelayanan'] ='ControllerPelayanan/simpan';
$route['Informasi'] ='ControllerInformasi';
$route['Informasi_input'] = 'ControllerInformasi/isi_informasi';
